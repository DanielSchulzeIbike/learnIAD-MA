...
- pre-post difference [linear regression]  ? XX
...
<video width="852" height="480" controls>
  <source src="www/intro IAD f.mp4" type="video/mp4">
</video>
...
<video width="852" height="480" controls>
  <source src="www/data f.mp4" type="video/mp4">
</video>
...
<video width="852" height="480" controls>
  <source src="www/2stage f.mp4" type="video/mp4">
</video>
...
```{r gather odds ratios, exercise=TRUE}
...
```{r MortalityMA-solution, exercise=TRUE}
...
## Naive Analysis (DON'T DO!)

__Logistic regression for all studies, ignoring study variable__

```{r Mortality log reg for all studies, echo=TRUE}

#!

mortality_all <- glm(survival ~ treatment, 
                     data = DatIAD, 
                     family = binomial)
summary(mortality_all)
tbl_regression(mortality_all,
               exponentiate = T)  %>%
  modify_header(label= "**Naive log reg**")

```
Overall effect of logOR = 0.28, ie. OR = 1.33: Odds of survival are 33% higher in JM-20 group than in untreated MCAO control. Non-significant.
